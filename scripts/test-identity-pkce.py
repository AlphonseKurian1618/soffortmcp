...
DEFAULT_RESOURCE = "https://consentary.com/mcp"
DEFAULT_SCOPE = "https://consentary.com/mcp/soffortbackend.access"
...
def receive_callback(redirect_uri: str, expected_state: str, timeout_seconds: int) -> str:
    ...
    class CallbackHandler(BaseHTTPRequestHandler):
        ...
        def do_GET(self) -> None:  # noqa: N802 - BaseHTTPRequestHandler API name.
            ...
            body = (
                b"<!doctype html><title>Consentary identity test</title>"
                ...
                b"<h1>Sign-in returned to Consentary.</h1>"
