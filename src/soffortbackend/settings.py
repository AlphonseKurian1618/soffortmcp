...
CANONICAL_MCP_URL = "https://consentary.com/mcp"
...
class Settings(BaseSettings):
    ...
    apns_topic: str = Field(default="com.consentary.app", min_length=1, max_length=255)
    ...
    allowed_hosts_csv: str = "consentary.com"
