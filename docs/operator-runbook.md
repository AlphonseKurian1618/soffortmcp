...
6. In Apple Developer, create a new **Apple Push Notifications service** key for `com.soffort.aivault`. Do not reuse `AuthKey_599S6S73Y2.p8`, which is the Sign in with Apple federation key. Record only the new Key ID as `APNS_KEY_ID`.
